...
function page_render (teamMembers) {
...
function generateManagerHtml (manager) {
    return `
        ...
        <div class="card-header">
            ...
            <h3 class="card-title"><i class="fas fa-building mr-2"></i>${manager.getRole()}</h3>
        </div>
        <div class="card-body">
            <ul class="list-group">
...
function generateEngineerHtml (engineer) {
    return `
        ...
        <div class="card-header">
            ...
            <h3 class="card-title"><i class="fab fa-android mr-2"></i>${engineer.getRole()}</h3>
        </div>
        <div class="card-body">
            <ul class="list-group">
